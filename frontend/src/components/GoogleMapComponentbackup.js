...
//       {renderCategory('event', 'Event', FaCar)}
...
//           // metadata: { topic: 'event', name: event.name, link: event.link }
//         });
//       }
//     });
...
//     } else {
//       // Handle cases where pixel values are not available
//     }
//   };
...
//   .map((marker, index) => {
//       console.log("Rendering Marker: ", marker);  // Debugging Line
//       return (
//           <Marker
//               key={index}
