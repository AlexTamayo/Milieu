...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    const businessCategoryData = [
      ...
      { name: 'Boutique', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Antiques', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Laundry Services', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Gardening', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Party Rentals', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Home Renovation', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Pest Control', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Locksmith', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Security Services', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Courier Services', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Childcare', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Elderly Care', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Wedding Planning', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Interior Design', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Home Decor', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Counseling', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Therapy', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Personal Training', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Life Coaching', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Tattoo Studio', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Furniture Store', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Electronics Repair', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Home Security', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Locksmith', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Party Supplies', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Clothing Store', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Shoe Store', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Florist', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Dry Cleaning', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Home Theater Installation', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Roofing', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Carpentry', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Cleaning Services', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Painting', createdAt: new Date(), updatedAt: new Date() },
